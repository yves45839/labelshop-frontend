...
import { blogPath, deleteBlog, formatDate, formatDateTime, type BlogData } from '@/lib/blogs';
...
export default function BlogsListClient({ initialBlogs }: { initialBlogs: BlogData[] }) {
